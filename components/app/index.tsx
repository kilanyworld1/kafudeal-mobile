...
export default function Splash() {
  ...
  useEffect(() => {
    ...
    Animated.loop(
      Animated.sequence([
        Animated.timing(float, { toValue: -6, duration: 2000, easing: Easing.inOut(Easing.ease), useNativeDriver: true }),
  ...
  return (
    ...
    >
      <Animated.View
        pointerEvents="none"
        style={[s.halo, { transform: [{ rotate: haloSpin }] }]}
      />
      ...
      <View style={s.center}>
        ...
        <Text style={s.footer}>FRESH STOCK · UAE STORES · DAILY DROPS</Text>
      </View>
    </LinearGradient>
  );
}
...
const s = StyleSheet.create({
  halo: {
    ...
    borderRadius: 150, borderWidth: 24,
    borderColor: "rgba(255,255,255,0.15)", opacity: 0.6,
  },
  skipBtn: {
  ...
  logoShadow: {
    ...
    shadowOffset: { width: 0, height: 18 }, shadowRadius: 40,
  },
  title: {
    fontSize: 56, fontWeight: "800", color: "white",
    letterSpacing: -1.8, marginTop: 28,
  },
