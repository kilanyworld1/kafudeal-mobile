...
const menu = [
  { icon: "location-outline" as const, label: "Addresses", sub: "2 saved" },
  { icon: "heart-outline" as const, label: "Saved deals", sub: "4 items" },
  { icon: "ticket-outline" as const, label: "Vouchers", sub: "1 active" },
